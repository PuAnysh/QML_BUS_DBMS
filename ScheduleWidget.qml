...
//                 myText: "司机查找"
                 MyButton{
                     ...
                     anchors.margins: 20
                     onBtnClicked: {
                         ScheduleWork.querys(tiname.text , tidriverid.text)
                     }
                 }
                 ...
                 MyButton{
                     ...
                     anchors.margins: 20
                     onBtnClicked: {
                         modifywidget.setIndex(scheduleTableView.currentRow)
                         modifywidget.show()
                     }
                 }
                 ...
                 MyButton{
                     ...
                     anchors.margins: 20
                     onBtnClicked: {
                         ScheduleWork.delItem(scheduleTableView.currentRow);
                     }
                 }

             }
             ScheduleModifyWidget{
                 id:modifywidget
                 visible: false
             }
